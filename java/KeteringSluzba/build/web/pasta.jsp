<%-- 
    Document   : pasta
    Created on : Feb 10, 2016, 5:57:14 PM
    Author     : Nikola90
--%>
...
<html>
    ...
    <body>
                    ...
                    <ul>
                        ...
                        <li><a href="ListaPica" title="">Pice</a></li>
                         ...
                         <li><a href="ListaSendvica" title="">Sendvici</a></li>
                            ...
                            %>
                        <li><a href="Reklamacije" title="">Poruke</a></li>
                            <% } else { %>
        ...
        <div id="conteiner">
            ...
            <% HttpSession poruka_sesija = request.getSession();
                String por = (String) poruka_sesija.getAttribute("poruka");
               if(por!= null && por.length()>0) {
            %>
            <h3 style="color:red; text-align: center;" ><%= por %></h3>
            <% } %>
             
            <% ArrayList<Proizvod> lp = (ArrayList<Proizvod>) request.getAttribute("listaPasta");
                for (Proizvod p : lp) {
            %>
            <div class="product2">
                <table class="table">
                    <tr>
                        <td class="deo0" style="padding-top: 12px">
                            <img src="<%= p.getSlika()%>" alt="logo" height="180px" width="175px" />
                        </td>
                        <td class="deo1">
                            <table class="teble">
                                <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="text-align: center;">
                            <a href="PrikaziPastu?sifra=<%= p.getSifra()%>" ><input type="button" class="button3" value="Izmeni"/></a>
                            <a href="BrisiPastu?sifra=<%= p.getSifra()%>" ><input type="button" class="button3" value="Obrisi"/></a>
                        </td>
                    </tr>
                        <% } else if (osoba != null) {%>
                         <tr>
                        ...
                        <td>
                            ...
                            <form action="KorpaPasta" method="post"> 
