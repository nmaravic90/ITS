<%-- 
    Document   : izmeniHamburger
    Created on : Feb 16, 2016, 6:44:39 PM
    Author     : Nikola90
--%>
...
<html>
    ...
    <body>
        ...
        <div class="forma">
            <form action="Izmeni_hamburger" method="post">
                <table>
                    <caption>
                        <h3>Izmani hamburger</h3><br/>
