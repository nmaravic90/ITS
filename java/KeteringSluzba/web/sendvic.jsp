<%-- 
    Document   : sendvic
    Created on : Feb 10, 2016, 5:56:51 PM
    Author     : Nikola90
--%>
...
<html>
    ...
    <body>
        <div id="header">
            ...
            <% ArrayList<Proizvod> lp = (ArrayList<Proizvod>) request.getAttribute("listaSendvica");
                for (Proizvod p : lp) {
            %>
            <div class="product2">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="text-align: center;">
                            <a href="PrikaziSendvic?sifra=<%= p.getSifra()%>" ><input type="button" class="button3" value="Izmeni"/></a>
                            <a href="BrisiSendvic?sifra=<%= p.getSifra()%>" ><input type="button" class="button3" value="Obrisi"/></a>
                        </td>
                    </tr>
                        <% } else if (osoba != null) {%>
                        <tr>
                        ...
                        <td>
                            ...
                            <form action="KorpaSendvic" method="post"> 
        ...
        <div id="tool-bar">
            ...
            <a href="dodajSendvic.jsp">Dodaj proizovd</a>
            <% } else { %>        
