<%-- 
    Document   : hamburger
    Created on : Feb 10, 2016, 5:57:01 PM
    Author     : Nikola90
--%>
...
<html>
    ...
    <body>
        ...
        <div id="conteiner">
            ...
            <% ArrayList<Proizvod> lp = (ArrayList<Proizvod>) request.getAttribute("listaHamburgera");
                for (Proizvod p : lp) {
            %>
            <div class="product2">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="text-align: center;">
                            <a href="PrikaziHamburger?sifra=<%= p.getSifra()%>" ><input type="button" class="button3" value="Izmeni"/></a>
                            <a href="BrisiHamburger?sifra=<%= p.getSifra()%>" ><input type="button" class="button3" value="Obrisi"/></a>
                        </td>
                    </tr>
                        <% } else if (osoba != null) {%>
                        <tr>
                        ...
                        <td>
                            ...
                            <form action="KorpaHamburger" method="post"> 
        ...
        <div id="tool-bar">
            ...
            <a href="dodajHamburger.jsp">Dodaj proizovd</a>
            <% } else { %>        
